...
<div>
	...
	<div class="row">
		<div class="col-6">
			<a class="btn btn-outline-primary btn-block" href="/mall-admin/product/editProductSoldoutAction.jsp?productId=<%=pac.product.productId%>&productSoldout=<%=pac.product.productSoldout%>">
				product_soldout 상태 변경
			</a>
		</div>
		<div class="col-3">
			<a class="btn btn-outline-primary btn-block" href="/mall-admin/product/editProduct.jsp?productId=<%=pac.product.productId%>">수정</a>
		</div>
		<div class="col-3">
			<a class="btn btn-outline-primary btn-block" href="/mall-admin/product/deleteProduct.jsp?productId=<%=pac.product.productId%>">삭제</a>
		</div>
	</div>
</div>
</div>
